		...
		<div class="w3ls_mobiles_grid_right_grid3">
			<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
							<div class="agile_ecommerce_tab_left mobiles_grid">			
								<?php
								function get_timpanidata()
								{
							include('config.php');
							if($db_found)
							{
								$SQL = "SELECT pid, pname, pprice, pdisc, pimg, pimg1, pimg2, manage_product.subcat_id, subcat_name FROM manage_product, subcat_master WHERE manage_product.subcat_id = subcat_master.subcat_id AND subcat_master.subcat_name =  'timpani'";
