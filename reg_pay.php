...
<tr>
	<td>
		<label><b> Instrument name:</b></label>
	</td>
	<td>
		<?php echo $instr_name;?>
	</td>
...
$sql1="SELECT * FROM instrument WHERE instr_name ='$instr_name'";

?>
 <tr>
 <td> <b>Class fees:</b></td>
<?php
...
<tr>
	<td>
	<a href="https://test.instamojo.com/@enlighteninfosystemss/?amount=<?php echo $class_fees; ?>"><button type="confirm"class="button button1" />Confirm to Pay</button></a>
	</td>
</tr>
</table>
