										...
										<div class="facts">
											<div class="register"
												<form action="reg.php" method="post">			
													...
													<input placeholder="Confirm Password" name="con_pass" type="password" required="">
													<div class="sign-up">
		...
		<div class="container">
			...
			<div class="agile_mail_grids">
				<div class="col-md-5 contact-left">
					<h4>Address</h4>
					<p>Aryan Music "Musical Instruments Portal"</p>
						
					<ul>
						<li>B-211,Lane No:4</li>
						<li>Sethi Nagar,Ujjain</li>
				...
				<div class="col-md-7 contact-left">
					...
					<form action="#" method="post">
						...
						<input type="text" name="tel_phone" placeholder="Telephone No" required="">
			...
			<div class="contact-bottom">
				<iframe src="https://www.google.com/maps/embed?pb=%22+%09%09%09%09%09%09+%09%09%09%09%09%09%09%09%09%09%09B-211,Lane+No:4%09%09%09%09%09%09Sethi+Nagar,Ujjain+%09%09%09%09%09%09Madhya+Pradesh%09%09%09%09%09456010/@23.1738583,75.7990044,16z/data=!3m1!4b1" frameborder="0" style="border:0" allowfullscreen></iframe>
			</div>
		</div>
	</div>
	<!-- //mail -->
