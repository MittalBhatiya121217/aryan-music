					...
					<ul class="nav navbar-nav">
						...
						<li class="w3pages"><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Academic Information <span class="caret"></span></a>
							<ul class="dropdown-menu">
								<li><a href="icons.html">Academic Information</a></li>
...
?>					
		<div class="w3ls_mobiles_grid_right_grid3">
			<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
							...
							<?php
							function get_dholdata()
							{
							include('config.php');
							if($db_found)
							{
								$SQL = "SELECT pid, pname, pprice, pdisc, pimg, pimg1, pimg2, manage_product.subcat_id, subcat_name FROM manage_product, subcat_master WHERE manage_product.subcat_id = subcat_master.subcat_id AND subcat_master.subcat_name =  'dhol'";
							...
							<img src="admin_new/<?php echo $pimg;?>" height="300" width="200"></img>
							<img src="admin_new/<?php echo $pimg1;?>" height="300" width="200"></img>
							<img src="admin_new/<?php echo $pimg2;?>"height="300" width="200"></img>
							</div>
							...
							<tr>
								<td>
									<audio controls>
										<source src="admin_new/dhol.ogg" type="audio/ogg">
										<source src="admin_new/dhol.mp3" type="audio/mpeg">
				...
				<li>
					<div class="w3l_related_products_grid">
						<div class="agile_ecommerce_tab_left mobiles_grid">
							...
							if($db_found)
							{
								$SQL = "SELECT * from manage_product where pname='classical tabla'";
							$result = mysql_query($SQL);
							while ($row = mysql_fetch_assoc($result))
							{
