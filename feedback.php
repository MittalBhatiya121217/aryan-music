			...
			<nav class="navbar navbar-default">
				...
				<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
					<ul class="nav navbar-nav">
						...
						<li><a href="feedback.php" class="act">Feedback</a></li> 
...
include("config.php");
   ...
   $sql="select MAX(fb_id) 'cnt' from feedback";
	$sql;
...
if ($conn->connect_error)
{
    ...
    $sql = "INSERT INTO `feedback`(fb_id,feedback,name,Date,Time) VALUES ('$fb_id','$feedback','$name',CURDATE(),CURTIME())";
...
if ($db_found) 
{
$SQL = "SELECT * FROM feedback order by time ASC";
...
<tr>
			...
			<td style='width:1000px; height:50px;text-align: left;' >
				<?php print $db_field['feedback'];?>
			
				
			<br/>
				Given by....
				<?php print $db_field['name'];?>
				<?php print $db_field['date'];?>
				<?php print $db_field['time'];?>
			</td>
</tr>
<?php } ?>
</table>
...
<table>
	...
	<tr>
		<td>
			<input type='text' name='fb_id' value="<?php echo $cnt; ?> " style='width:500px; height:50px;'required>
			
		</td>
	</tr>
	<tr>
		<td>
			<input type='text' name='name' value='<?php if(isset($_SESSION['name'])){ echo $_SESSION['name']; }?>' placeholder="Enter Your name "style='width:500px; height:50px;'required>
			
		</td>
	</tr>
	<tr>
		<td>
			<input type='text' name='feedback' placeholder="Enter Your Feedback "style='width:500px; height:50px;'required>
	...
	<tr>
		<td>
			<button type='submit' name='add' class='button button1' style='height: 50px; width: 250px; left: 250; top: 250; background-color:#d3d3d3;color:red;'>Send</button>
		
			<button type='reset' name='cancel' class='button button1' onclick='ClearFields()'style='height: 50px; width: 250px; left: 250; top: 250;background-color:#d3d3d3;color:red;'>Cancel</button>
		</td>
	</tr>
</table>
</form>	
