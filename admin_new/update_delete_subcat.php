							...
							<div class="header">
								<div class="head-t">
									...
									<div class="header_right">
										...
										<h1><font color="red"><b> Update / Delete Subcategory </b></h1>
										<div class="clearfix"> </div>
									</div>
...
if(isset($_POST['add']))
{
	...
	$sql = "update `subcat_master` set subcat_name='$subcat_name' where subcat_id='$subcat_id';"; 
...
$id = $_GET['id'];
			...
			$sql1="SELECT * from subcat_master where subcat_id='$id'";
...
<table>
	<tr>
		...
		<td>
				<input type='text' name='subcat_id' value="<?php if(isset($_GET['id'])) { echo $subcat_id;}?>">
		</td>
	</tr>
	...
	<tr>
		...
		<td>
				<input type='text' name='subcat_name' value="<?php if(isset($_GET['id'])) { echo $subcat_name;}?>">
		</td>
	</tr>
...
<center>
<!--select query coding -->
<form  method="POST" action="delete_subcat.php">
<script>
...
if ($db_found)
{
	$SQL = "SELECT * FROM subcat_master order by subcat_id desc";
?>
...
?>
	<tr>
		...
		<td>
				<?php print $db_field['subcat_name']; ?>
		</td>
		...
		<td>
				<a href="update_delete_subcat.php?id=<?php echo $db_field['subcat_id'];?>"><input type='button' name='update' class="button button1" value='Update' style='height: 50px; width: 150px; left: 250; top: 250; '></a>
		</td>
		
		<td>
				<a href="delete_subcat.php?id=<?php echo $db_field['subcat_id'];?>"><input type='button' name='delete' class="button button1" Onclick='return ConfirmDelete()'  value='Delete'  style='height: 50px; width: 150px; left: 250; top: 250;'>
	</tr>
